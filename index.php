			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="images/factura.PNG" class="brand_logo" alt="Logo">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">
					<form action="login.php" method="POST">
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="password_hash" class="form-control input_pass" value="" placeholder="Password" required>
						</div>
